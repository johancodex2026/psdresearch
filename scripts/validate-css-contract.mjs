...
const legalPages = [
  "pt-br/privacidade/index.html", "en/privacy/index.html",
  "pt-br/termos-de-uso/index.html", "en/terms-of-use/index.html",
  "pt-br/cookies-e-rastreamento/index.html", "en/cookies-and-tracking/index.html",
  "pt-br/acessibilidade/index.html", "en/accessibility/index.html",
  "pt-br/seguranca/index.html", "en/security/index.html",
  "pt-br/transparencia/index.html", "en/transparency/index.html",
  "pt-br/direitos-e-licencas/index.html", "en/rights-and-licenses/index.html",
  "pt-br/contato/index.html", "en/contact/index.html",
];

const contracts = [
  { pages:["pt-br/index.html","en/index.html"], requiredStyles:["/assets/css/home-v2.css","/assets/css/home-scale.css"], selectors:[".home-social-v2 .hero-social h1",".living-architecture",".scenario-grid"] },
  { pages:["pt-br/manifesto/index.html","en/manifesto/index.html"], requiredStyles:["/assets/css/manifesto.css"], selectors:[".world-signal-grid",".manifesto-article",".reference-list"] },
  { pages:["pt-br/arquitetura/index.html","en/architecture/index.html"], requiredStyles:["/assets/css/architecture.css"], selectors:[".architecture-page .architecture-hero h1",".methodology-grid",".sedimentation-flow"] },
  { pages:["pt-br/pesquisa/index.html","en/research/index.html"], requiredStyles:["/assets/css/research.css"], selectors:[".research-page .research-hero h1",".research-contract"] },
...
for (const contract of contracts) {
  for (const page of contract.pages) {
    ...
    if (!await exists(htmlPath)) { fail(`site/${page}: page does not exist`); continue; }
    const html = await readFile(htmlPath, "utf8");
    const stylesheets = extractStylesheets(html);
    for (const required of contract.requiredStyles) {
      if (!stylesheets.includes(required)) fail(`site/${page}: missing required stylesheet ${required}`);
    }
    let combined = "";
    ...
    for (const selector of contract.selectors) {
      if (!combined.includes(selector)) fail(`site/${page}: stylesheet graph does not define critical selector ${selector}`);
    }
  }
}
...
if (await exists(headersPath)) {
  ...
  if (immutableUnversionedAssets.test(headers)) fail("site/_headers: unversioned /assets/* must not be cached as immutable");
} else fail("site/_headers: file does not exist");
