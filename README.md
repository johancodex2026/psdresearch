...
PSDResearch uses **Proto-Digital Being (PDB)** in English and **Proto-Ser Digital (PSD)** in Portuguese as controlled research terms. The project does **not** claim that an LLM, agent, or chatbot is conscious, sentient, alive, sovereign, or a legal person.

## Founding governance

PSDResearch recognizes:
